...
while (condition) {
    ...
    let q2 = await inquirer.prompt([
        {
            name: "question",
            message: "What was the primary purpose behind the creation of JavaScript?\n",
            type: "list",
            choices: [
    ...
    let q4 = await inquirer.prompt([
        {
            name: "question",
            message: "Which of the following is an example of asynchronous code in JavaScript?",
            type: "list",
            choices: [
    ...
    let q5 = await inquirer.prompt([
        {
            name: "question",
            message: "Which of the following is NOT a valid way to declare a variable in JavaScript?\n",
            type: "list",
            choices: [
                "a) let x = 10;",
                "b) const PI = 3.14;",
